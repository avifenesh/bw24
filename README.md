...
Measured 2026-07-09 on the target rig (RTX 5090 Laptop, N≥3 medians, power state verified before every session) against llama.cpp built on the same machine, same exact prompts, both engines re-baselined the same day. Boards move with the tuning campaign — `research/tune-data/rig5090.jsonl` is the running record; the README is refreshed with every board-moving merge.
<!-- PERF-DATE:END -->
...
|---|---|---|---|
| Qwen3.6-27B NVFP4 | 47.8 | 43.5 | **1.10x** |
| Qwen3.5-9B NVFP4 | 134.6 | 124.6 | **1.08x** |
| Qwen3.6-35B-A3B MoE | 173.6 | 170.5 | 1.02x |
<!-- PERF-PLAIN:END -->
