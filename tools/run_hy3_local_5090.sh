...
exec taskset --cpu-list "$cpu_list" env \
  ...
  BW24_MOE_VRAM_FRAC="${BW24_MOE_VRAM_FRAC:-0.85}" \
  BW24_MOE_HARD_VRAM_FRAC="${BW24_MOE_HARD_VRAM_FRAC:-0.85}" \
  ...
  BW24_CPU_EXPERT_CACHE_GB="${BW24_CPU_EXPERT_CACHE_GB:-36}" \
