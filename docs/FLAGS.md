...
| `BW24_CPU_EXPERT_IO_CPUSET` | inherit | optional cpu list (e.g. `8-15`) pinning the async read pool off the compute cores; the Hy3 5090 launcher pins io to E-cores |
