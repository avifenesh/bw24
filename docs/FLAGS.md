...
| `BW24_SPEC_ADAPT_FLOOR=<n>` | override the adaptive-K floor (default is per-model: n_embd≥5000 → 4, ≥3500 → 3, else 1) | per-model floor default 2026-07-25: floor-1 collapses to shallow drafts after a miss; expensive-verify models win big raising it (31B floor4 K5 120.2 vs 103.8 = +15.7%; 12B floor3 K3 214.9 vs 200.6 = +7.1%; 26B/E4B keep 1 — floor2 measured worse 2026-07-10) |
