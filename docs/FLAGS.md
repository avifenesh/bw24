...
| `BW24_SPEC_ADAPT_FLOOR=<n>` | override the adaptive-K floor (default is per-model: n_embd≥3500 → 4, else 1; clamps to K) | per-model floor default 2026-07-25: floor-1 collapses to shallow drafts after a miss; expensive-verify models win big raising it (31B K5 floor4 120.2 vs 103.8 = +15.7%; 12B K4 floor4 240.5 vs 200.6 = +20%; floor 5+ falls off both; 26B/E4B keep 1 — floor2 measured worse 2026-07-10) |
...
| `BW24_FA_F16PV=0` | f32-class rollback: bf16-P + f32 P@V prefill accumulation (pre-door numerics) | f16 class DEFAULT 2026-07-23 (stamp v4: 12B 1.045x, 31B 0.979x) |
