...
| flag | default | what it does |
|---|---|---|
| `BW24_PP_FP8` | off | `1` enables the cuBLASLt FP8-activation prefill GEMM on FP8-native (safetensors) checkpoints. +78–129% pp on g7e (2026-07-08); local verification in flight — flip to default when it lands |
| `BW24_PP_FP8_BUDGET_MB` | 1536 | VRAM budget for resident FP8 weight copies (rig-dependent; 2560 = +16.6% pp1845 on 24GB, 2026-07-08) |
| `BW24_KV_K` | `q8_0` | K-cache format arm: `fp8` = −7…−14% FA decode µs, acceptance CLEAN (2026-07-08). Candidate default after the e2e board |
