...
int bw24_mmq_q4_K(const void * W_q4k_blocks, const float * act_f32, float * y,
                  int in_f, int out_f, int n_tokens, void * act_scratch, void * stream) {
    return bw24_mmq_q45k_launch<4>(W_q4k_blocks, act_f32, y, in_f, out_f, n_tokens, act_scratch, stream);
}

// Run the Q5_K W4A8 MMQ prefill GEMM. Returns 0 on success, else (1000 + cudaError).
int bw24_mmq_q5_K(const void * W_q5k_blocks, const float * act_f32, float * y,
                  int in_f, int out_f, int n_tokens, void * act_scratch, void * stream) {
    return bw24_mmq_q45k_launch<5>(W_q5k_blocks, act_f32, y, in_f, out_f, n_tokens, act_scratch, stream);
}
