...
fn main() {
    eprintln!("cutlass_smoke: built without MEMRA_CUTLASS — rebuild with MEMRA_CUTLASS=1 to run the gate.");
    std::process::exit(2);
}
...
#[cfg(memra_cutlass)]
fn run_shape(eng: &memra_engine::Engine, m: usize, n: usize, k: usize)
