...
pub enum Event {
    ...
    /// and how many of those came from a cache (continuation pool, spec resume, or the
    /// cross-request prefix cache) instead of being computed — the OpenAI
    /// `usage.prompt_tokens_details.cached_tokens` source.
